...
- **Entregables**: `src/backend/agents/persistence.ts` con métodos `saveSession` y `loadSession`.
...
- **Dependencias**: Paso 1.
- **Entregables**: `src/backend/agents/registry.ts` capaz de instanciar objetos `Agent` del SDK.
- **Agente responsable**: **Coding-Agent**
...
- **Dependencias**: Paso 2.
- **Entregables**: `src/backend/agents/runtime.ts` con método `processMessage(sessionId, text)`.
- **Agente responsable**: **Coding-Agent**
...
- **Dependencias**: Paso 4.
- **Entregables**: `src/backend/routes/chat.ts`.
- **Agente responsable**: **Coding-Agent**
