...
version: 1.0.0
trigger: ["phase1", "phase-1", "research"]
type: static
---
...
- Template: `templates.research` (if it does not exist or cannot be loaded → FAIL)

## Output
- Research report (generated by researcher-agent):
...
4. Request developer approval (via console)
