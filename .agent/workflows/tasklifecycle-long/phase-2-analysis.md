...
version: 1.0.0
trigger: ["phase2", "phase-2", "analysis"]
type: static
---
...
- Template: `templates.analysis` (if it does not exist or cannot be loaded → FAIL)
...
7. Define agents and sub-areas
   ...
   - **Verify that each agent exists in `.agent/rules/roles/`**.
...
## Fail
- Declare Phase 2 as **NOT completed**.
