...
version: 1.0.0
trigger: ["phase5", "phase-5", "verification", "verify"]
type: static
---
...
- Template: `templates.verification` (if it does not exist or cannot be loaded → FAIL)
...
7. Request developer approval (via console)
...
## Fail
- Declare Phase 5 as **NOT completed**.
- FAIL cases:
...
- Delegate correction (DO NOT fix code):
