...
version: 1.0.0
trigger: ["phase8", "phase-8", "commit", "push"]
type: static
---
...
## Objective
- Consolidate all changes into well-structured commits following Conventional Commits.
- Generate a changelog documenting all commits.
- Push changes to the target branch with explicit developer approval.
...
## Fail
- Declare Phase 8 as **NOT completed**.
- FAIL cases:
