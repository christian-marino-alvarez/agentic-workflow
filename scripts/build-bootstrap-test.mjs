...
const distRoot = path.resolve("dist/agent");
const outPath = path.join(path.resolve("dist"), "bootstrap-test.md");

const files = [
  { rel: "rules/constitution/agents-behavior.md", alias: "constitution.agents_behavior" },
  { rel: "rules/constitution/modular-architecture.md", alias: "constitution.modular_architecture" },
