...
const files = [
  { rel: "rules/index.md", alias: "agent.core.rules" },
  { rel: "workflows/index.md", alias: "agent.core.workflows" },
  { rel: "templates/index.md", alias: "agent.core.templates" },
  { rel: "artifacts/index.md", alias: "agent.core.artifacts" },
  { rel: "rules/constitution/GEMINI.location.md", alias: "constitution.GEMINI.location" },
  { rel: "rules/constitution/project-architecture.md", alias: "constitution.project-architecture" },
  { rel: "rules/constitution/clean-code.md", alias: "constitution.clean-code" },
  { rel: "rules/constitution/agent-system.md", alias: "constitution.agent-system" },
...
async function build() {
  ...
  let bundle = "# CORE BOOTSTRAP BUNDLE\n\n";
  ...
  bundle += "El core está cargado. Puedes profundizar usando:\n";
