...
export { Message, MessageHandler, Payload, IMessageTransport } from './types.js';
export { Logger } from './logger.js';
export * from './messaging/index.js';
export * from './background/index.js';
export { View } from './view/index.js';
export * as ViewHtml from './view/html.js';
...
export abstract class App {
   ...
   */
  public abstract activate(shell: vscode.WebviewViewProvider): Promise<void>;
