...
export type WorkflowViewTemplateParams = {
  nonce: string;
  scriptUri: string;
  cspSource: string;
};

export class WorkflowViewTemplate {
...
<html lang="en">
  ...
  <body>
    <div id="loading" class="loading" hidden>Loading… [workflows]</div>
    <h3>Workflows</h3>
    <p>Coming soon. TODO: Workflow markdown editor view.</p>
    <script nonce="__NONCE__" src="__SCRIPT_URI__" defer></script>
  </body>
</html>`);
  }

  public render(params: WorkflowViewTemplateParams): string {
